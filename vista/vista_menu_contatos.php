...
<body onload="btn_listar_datos_contato(<?php echo $_SESSION['cod']; ?>);">
	<h1> Controle de contatos (cliente) </h1>
						...
						<td>
				    		...
				    		<table class="table table-condensed" style="width: 100%;">
				    			<tr>
				    				...
				    				<td> <input type="text" id="contato" class="form-control" placeholder="* Deve ser o mesmo nome que aparece nos contatos do Whatsapp!"></td>
								</tr>
				    			<tr> <td> <label> Ativo no fluxo </label></td>
				    				<td>
				    		...
				    		<tr> <td> <label> Cadastro no Google Contatos </label></td>
				    				<td>
										<select id="cadastro" class="form-control">
										...
										<tr>
											<td colspan="2">
												<div id="panel_respuesta_contato"></div>
											</td>
										</tr>
										<tr>
				    				<td colspan="2" align="center">
				    					<button class="btn btn-success btn-md" onclick="btn_guardar_dato_contato(<?php echo $_SESSION['cod']; ?>);"> Registrar </button>
				    				</td>
				    			</tr>
				    		</table>
    ...
    <div class="col-lg-12 col-md-12 xs-12">
    	...
    	<button class="btn btn-info btn-md" onclick="btn_listar_datos_contato(<?php echo $_SESSION['cod']; ?>);"> Listar </button>
        <button class="btn btn-info btn-md" data-toggle="modal" data-target="#myModal_selector_contato"> Selecinar </button>
    	<div id="panel_listado_contato">
    		<!-- Panel de datos -->
...
<!-- Modal -->
<div id="myModal_selector_contato" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div id="panel_selector_contato"></div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-info" onclick="btn_eliminar_dato_contato();"> Eliminar </button>
