...
<?php
 ...
 ?>
 <br>'
 <button type="button" class="btn btn-success"  onclick="start_recarrega($codusuario);"> Atualizar </button>';

</tr>
</table>
<?php
} else {
  $query2 = "update login i set i.start = 'N', i.status = 'N' where i.codusuario = $codusuario order by codlogin limit 1";
  $sql2 = mysqli_query($conn, $query2);
  ?>
  <button type="button" class="btn btn-danger" data-dismiss="modal" onclick="start_fin(<?php echo $codusuario; ?>);"> Interromper </button>
